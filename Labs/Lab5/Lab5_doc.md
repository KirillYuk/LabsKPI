...
Додано базові приклади використання для демонстрації.

### Підсумок

В результаті роботи реалізовано 3 версії асинхронного map:
- версія з callback
- паралельна версія через asyncio.gather
- послідовна версія з підтримкою скасування
---

Тестування можна провести запустивши `test.py`.

>Дана реалізація є навчальною та демонструє базові принципи асинхронного програмування в Python. Код можна розширювати та оптимізувати залежно від задачі.